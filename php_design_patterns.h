...
#ifndef PHP_PHP_DESIGN_PATTERNS_H
#define PHP_PHP_DESIGN_PATTERNS_H
...
#define PHP_PHP_DESIGN_PATTERNS_VERSION "0.1.0" /* Replace with version number for your extension */

#ifdef PHP_WIN32
#	define PHP_PHP_DESIGN_PATTERNS_API __declspec(dllexport)
#elif defined(__GNUC__) && __GNUC__ >= 4
#	define PHP_PHP_DESIGN_PATTERNS_API __attribute__ ((visibility("default")))
#else
#	define PHP_PHP_DESIGN_PATTERNS_API
#endif
